var home_page = function() {
  ...
  this.clickOnEye = function() { // клик на action копку "Глаз" вкл/выкл
    element(by.xpath('//*[@id="sign-up-form-container"]/div/form/label[2]/div[1]/button/i')).click();
  };

  this.clickLinkRecoveryPass = function() { // клик на ссылку "Забыли пароль?"
    element(by.xpath('//*[@id="sign-up-form-container"]/a')).click();
  };
